...
async function onFormSubmit(formData) {
  ...
  try {
    ...
    const payload = {
      ...
      spouse_name: (Array.isArray(formData.spouseIds) && formData.spouseIds.length > 0) ? null : (editingMember.value && (!editingMember.value.spouseIds || editingMember.value.spouseIds.length === 0) ? editingMember.value.spouse : null),
      father_name: (formData.fatherId ?? null) ? null : (editingMember.value && !editingMember.value.fatherId ? editingMember.value.fatherName : null),
      mother_name: (formData.motherId ?? null) ? null : (editingMember.value && !editingMember.value.motherId ? editingMember.value.motherName : null),
